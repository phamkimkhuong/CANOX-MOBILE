...
export default function VerifyOtpScreen() {
                ...
                { email, otpCode: completedOtp },
                {
                    ...
                    onError: (error) => {
                        ...
                        Toast.show({
                            ...
                            text2: error.message || 'Vui lòng kiểm tra lại mã.',
                        });
                    },
                }
            );
    ...
    }, [email, isCountdownActive, isResending, resendOtp, startCountdown]);
                ...
                >
                    ...
                    <View style={styles.illustrationSection}>
                        <View style={styles.iconCircle}>
                            <MaterialIcons name="mail-outline" size={48} color={theme.colors.primary} />
                        </View>
                        <Text style={styles.title}>Nhập mã xác thực</Text>
                        <Text style={styles.subtitle}>
                            Chúng tôi đã gửi mã {OTP_LENGTH} số đến email
                        </Text>
                    ...
                    <TouchableOpacity style={styles.changeEmailBtn} onPress={handleBack}>
                        <Text style={styles.changeEmailText}>Đổi địa chỉ email khác</Text>
                    </TouchableOpacity>
                </ScrollView>
            </KeyboardAvoidingView>
        </SafeAreaView>
