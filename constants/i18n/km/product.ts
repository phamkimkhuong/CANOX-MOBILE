...
export const PRODUCT_STRINGS: ProductTranslation = {
    ...
    // === Order Protection ===
    orderProtection: {
        cardTitle: 'គោលការណ៍ការពារការបញ្ជាទិញរបស់ TCano',
        cardSubtitle: 'ការបញ្ជាទិញត្រូវបានការពារនៅពេលបង់ប្រាក់ និងដំណើរការតាមវេទិកា TCano',
        sheetTitle: 'ការពារការបញ្ជាទិញ',
        sheetHeading: 'គោលការណ៍ការពារការបញ្ជាទិញរបស់ TCano',
        sheetIntro: 'TCano ជួយការពារការបញ្ជាទិញនៅពេលប្រតិបត្តិការត្រូវបានបង់ប្រាក់ និងដំណើរការតាមវេទិកា។',
        learnMore: 'ស្វែងយល់បន្ថែម',
        items: {
            payment: {
                summaryTitle: 'ការបង់ប្រាក់មានសុវត្ថិភាព',
                title: 'ការបង់ប្រាក់មានសុវត្ថិភាព',
                description: 'ជ្រើសរើសវិធីបង់ប្រាក់ក្នុងស្រុក កាតឥណទាន/ឥណពន្ធ ការផ្ទេរប្រាក់តាមធនាគារ ឬកាបូបអេឡិចត្រូនិក។\nរាល់ប្រតិបត្តិការតាមរយៈ TCano ត្រូវបានការពារដោយការអ៊ិនគ្រីប SSL និងពិធីសារសុវត្ថិភាពទិន្នន័យ PCI DSS យ៉ាងតឹងរ៉ឹង។',
                policyTitle: 'គោលការណ៍បង់ប្រាក់',
            },
            shipping: {
                summaryTitle: 'តាមដានការដឹកជញ្ជូន',
                title: 'តាមដានការដឹកជញ្ជូន',
                description: 'TCano ជួយតាមដានស្ថានភាពការបញ្ជាទិញចាប់ពីពេលដាក់បញ្ជាទិញរហូតដល់ដឹកជញ្ជូនជោគជ័យ។',
            ...
            support: {
                ...
                description: 'ចូលប្រើប្រាស់មជ្ឈមណ្ឌលជំនួយអនឡាញ 24/7 របស់ TCano ឬទាក់ទងបុគ្គលិកគាំទ្រដើម្បីទទួលការជួយ និងដោះស្រាយរាល់បញ្ហាដែលពាក់ព័ន្ធនឹងការបញ្ជាទិញ។',
                policyTitle: 'មជ្ឈមណ្ឌលជំនួយ',
            },
        },
    },
    ...
    priceBreakdown: {
        ...
        platformVoucher: 'ប័ណ្ណបញ្ចុះតម្លៃ TCano',
        finalSubtotal: 'សរុប',
