...
export const PRODUCT_STRINGS: ProductTranslation = {
    ...
    specs: {
        ...
        madeToOrder: 'Hàng đặt trước (Pre-order)',
        inStock: 'Hàng có sẵn',
        warrantyTitle: 'Chính sách bảo hành & Đồng kiểm',
        warrantyType: 'Loại bảo hành',
        warrantyDuration: 'Thời hạn',
        warrantyActivation: 'Kích hoạt',
        warrantyInspection: 'Đồng kiểm',
        inspectionAllowed: 'Được đồng kiểm',
        inspectionNotAllowed: 'Không đồng kiểm',
        conditionsTitle: 'Điều kiện bảo hành & Đổi trả',
        typeManufacturer: 'Hãng bảo hành',
        typeShop: 'Shop bảo hành',
        typeNone: 'Không bảo hành',
        typeDefault: 'Bảo hành tiêu chuẩn',
        activationInvoice: 'Qua hóa đơn mua hàng',
        activationElectronic: 'Bảo hành điện tử',
        activationDefault: 'Liên hệ cửa hàng',
    },
