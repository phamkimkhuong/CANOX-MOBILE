...
export const ADDRESS_STRINGS: AddressTranslation = {
    ...
    form: {
        ...
        search: {
            label: 'Gợi ý địa chỉ từ Google Maps',
            placeholder: 'Tìm nhanh: Số nhà, tên đường...',
            searching: 'Đang tìm kiếm...',
            noResults: 'Không tìm thấy địa chỉ gợi ý',
        },
    },
    picker: {
        locationTitle: 'Chọn địa chỉ khu vực',
        provinceTitle: 'Chọn Tỉnh/Thành phố',
        districtTitle: 'Chọn Quận/Huyện',
        wardTitle: 'Chọn Phường/Xã',
        countryTitle: 'Chọn Quốc gia',
        provincePlaceholder: 'Tìm kiếm tỉnh/thành phố...',
        districtPlaceholder: 'Tìm kiếm quận/huyện...',
