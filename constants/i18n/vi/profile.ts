...
export const PROFILE_STRINGS: ProfileTranslation = {
    ...
    deleteAccount: {
        ...
        warningItem1: 'Tài khoản của bạn sẽ bị vô hiệu hóa ngay lập tức và xóa vĩnh viễn sau 30 ngày.',
        ...
        warningItem4: 'Các đơn hàng đang trong quá trình vận chuyển vẫn sẽ tiếp tục được giao.',
