...
export const PRODUCT_STRINGS: ProductTranslation = {
    ...
    // === Order Protection ===
    orderProtection: {
        cardTitle: 'ນະໂຍບາຍປົກປ້ອງຄໍາສັ່ງຊື້ຂອງ TCano',
        cardSubtitle: 'ຄໍາສັ່ງຊື້ໄດ້ຮັບການປົກປ້ອງເມື່ອຊໍາລະເງິນ ແລະດໍາເນີນການຜ່ານແພລດຟອມ TCano',
        sheetTitle: 'ປົກປ້ອງຄໍາສັ່ງຊື້',
        sheetHeading: 'ນະໂຍບາຍປົກປ້ອງຄໍາສັ່ງຊື້ຂອງ TCano',
        sheetIntro: 'TCano ຊ່ວຍປົກປ້ອງຄໍາສັ່ງຊື້ເມື່ອທຸລະກໍາຖືກຊໍາລະ ແລະດໍາເນີນການຜ່ານແພລດຟອມ.',
        learnMore: 'ຮຽນຮູ້ເພີ່ມ',
        items: {
            payment: {
                summaryTitle: 'ຊໍາລະເງິນປອດໄພ',
                title: 'ຊໍາລະເງິນປອດໄພ',
                description: 'ເລືອກວິທີຊໍາລະເງິນພາຍໃນປະເທດ, ບັດເຄຣດິດ/ເດບິດ, ໂອນຜ່ານທະນາຄານ ຫຼື ກະເປົາເງິນອີເລັກໂທຣນິກ.\nທຸກທຸລະກໍາຜ່ານ TCano ໄດ້ຮັບການປົກປ້ອງດ້ວຍການເຂົ້າລະຫັດ SSL ແລະ ມາດຕະຖານການຮັກສາຄວາມປອດໄພຂໍ້ມູນ PCI DSS ຢ່າງເຄັ່ງຄັດ.',
                policyTitle: 'ນະໂຍບາຍຊໍາລະເງິນ',
            },
            shipping: {
                summaryTitle: 'ຕິດຕາມການຈັດສົ່ງ',
                title: 'ຕິດຕາມການຈັດສົ່ງ',
                description: 'TCano ຊ່ວຍຕິດຕາມສະຖານະຄໍາສັ່ງຊື້ຕັ້ງແຕ່ສັ່ງຊື້ຈົນເຖິງຈັດສົ່ງສໍາເລັດ.',
            ...
            support: {
                ...
                description: 'ເຂົ້າເຖິງສູນຊ່ວຍເຫຼືອອອນລາຍ 24/7 ຂອງ TCano ຫຼື ຕິດຕໍ່ພະນັກງານເພື່ອຮັບການຊ່ວຍເຫຼືອ ແລະ ແກ້ໄຂບັນຫາກ່ຽວກັບຄຳສັ່ງຊື້.',
    ...
    priceBreakdown: {
        ...
        platformVoucher: 'ບັດສ່ວນຫຼຸດ TCano',
